...
- (void)viewDidLoad {
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:[XMGBackView backViewWithImageName:@"navigationButtonReturn" HighlightName:@"navigationButtonReturnClick" target:self action:@selector(back)]];
}
